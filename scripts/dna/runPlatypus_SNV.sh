...
python2.7 $PLATYPUS_BINARY callVariants --bamFiles=$FILENAME --refFile=$REFERENCE --regions=$BED_FILE --output=${OUT}_snv.vcf --filterDuplicates=0 --nCPU=$DNA_PARALLEL_ALIGNMENT --genSNPs 1 --genIndels 0 --logFileName=$OUT.log
