...
$ANNOVAR_HOME/table_annovar.pl $AVINPUT $ANNOVAR_DB -buildver hg19 -out $CSV_OUT -remove -otherinfo -protocol refGene,cytoBand,genomicSuperDups,esp6500siv2_all,1000g2015auf_all,1000g2015_eur,exac03,avsnp147,dbnsfp30a,snp138,ljb26_all -operation g,r,r,f,f,f,f,f,f,f,f -nastring NA -csvout
