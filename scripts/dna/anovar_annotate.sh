...
$ANNOVAR_HOME/table_annovar.pl $AVINPUT $ANNOVAR_DB -buildver hg19 -out $CSV_OUT -remove -otherinfo -protocol refGene,cytoBand,snp138,ljb26_all -operation g,r,f,f -nastring NA -csvout
